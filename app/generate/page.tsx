            ...
            {wallets.length > 0 && (
              <div className="mt-6 text-center">
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#EBF73F] to-[#EBF73F] text-black font-semibold rounded-lg hover:opacity-90 transition-all"
                >
